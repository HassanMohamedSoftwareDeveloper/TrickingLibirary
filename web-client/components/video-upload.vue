      ...
      <v-stepper-items>
        <v-stepper-content step="1">
          <div class="d-flex flex-column align-center">
            ...
            <v-btn @click="setType(uploadType.SUBMISSION)" class="my-2"
              >Submission</v-btn
            >
          </div>
        </v-stepper-content>
        ...
        <v-stepper-content step="3">
          <div>
            <v-text-field
              ...
              v-model="trickName"
            ></v-text-field>
            <v-btn @click="saveTricks">Save Tricks</v-btn>
          </div>
        </v-stepper-content>
...
export default {
  ...
  methods: {
    ...
    async saveTricks() {
      ...
      console.log(video);
      await this.createTrick({ trick: { trickName: this.trickName, video } });
      this.trickName = "";
      this.reset();
    },
  },
